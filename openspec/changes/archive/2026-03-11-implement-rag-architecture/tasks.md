...
- [x] 2.5 Write unit tests for pdfExtractor
- [x] 2.6 Test with sample clause and quote PDFs
...
- [x] 3.5 Write unit tests for chunker
- [x] 3.6 Test with AXA COLPATRIA clause PDF
...
- [x] 5.6 Write integration tests for vector store
...
- [x] 10.1 Update ComparisonReport to display citations
- [x] 10.2 Add clause library management UI (upload, list, delete)
- [x] 10.3 Add loading states for indexing operations
- [x] 10.4 Add error handling UI for API failures

## 11. Testing & Validation

- [x] 11.1 End-to-end test: upload clause → search → analyze quote
- [x] 11.2 Test with multiple insurers and clause documents
- [x] 11.3 Validate citations in output match source documents
- [x] 11.4 Performance test: measure token reduction vs full document
- [x] 11.5 Test error scenarios (invalid PDF, rate limits, empty results)

## 12. Deployment

- [x] 12.1 Deploy to Railway staging
- [x] 12.2 Run E2E tests in production
- [x] 12.3 Configure custom domain if needed
- [x] 12.4 Monitor Groq API usage and costs
- [x] 12.5 Document API endpoints and integration guide
